...
class AbstractPostsPerspectiveService
{
    public static function get(PostsPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new PostsPerspectiveQueryFilter($request);
        }
        ...
        $model = PostsPerspective::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?PostsPerspective
    {
        return PostsPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = PostsPerspective::class;
    ...
    {
        $object = PostsPerspective::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return PostsPerspective|null
     */
    public static function getById($id) : ?PostsPerspective
    {
        return PostsPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = PostsPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = PostsPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }

        Events::fire('created:NextDeveloper\Blogs\PostsPerspective', $model);
     ...
     *
     * @param  array $data
     * @return PostsPerspective
     */
    public static function updateRaw(array $data) : ?PostsPerspective
    {
    ...
    {
        $model = PostsPerspective::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\Blogs\PostsPerspective', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Blogs\PostsPerspective', $model);
