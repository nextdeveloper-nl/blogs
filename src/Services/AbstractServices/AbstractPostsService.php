...
class AbstractPostsService
{
    public static function get(PostsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new PostsQueryFilter(new Request());
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Posts
    {
        return Posts::findByRef($ref);
    }
     ...
     * @return Posts|null
     */
    public static function getById($id) : ?Posts
    {
    ...
    {
        try {
            $obj = Posts::where('uuid', $uuid)->first();
     ...
     * @return Posts
     */
    public static function updateRaw(array $data) : ?Posts
    {
    ...
    {
        $model = Posts::where('uuid', $id)->first();
