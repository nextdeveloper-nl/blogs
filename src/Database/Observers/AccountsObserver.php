...
class AccountsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Blogs\Accounts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Blogs\Accounts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Blogs\Accounts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Blogs\Accounts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Blogs\Accounts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Blogs\Accounts', $model);
    }
